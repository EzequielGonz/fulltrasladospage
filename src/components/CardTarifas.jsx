    ...
    <>
      {
        ...
        <span className="text-black">Fiat Dobló/Kangoo: {item.fiat_doblo_kangoo && item.fiat_doblo_kangoo.includes("consultar") ? item.fiat_doblo_kangoo : <b className="text-success alter-font">${item.fiat_doblo_kangoo}</b>}</span>
